...
class Hasher {
  TSLimitQueue<std::unique_ptr<PoolCharArray>> &m_inQueue;
...
public:
  explicit Hasher(TSLimitQueue<std::unique_ptr<PoolCharArray>> &inQueue,
